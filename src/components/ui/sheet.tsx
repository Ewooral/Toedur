...
function getSheetVariants(theme: Theme) {
  const cvaResult = cva(
  ...
  return { cva: cvaResult, style };
}

interface SheetContentProps
  extends React.ComponentPropsWithoutRef<typeof SheetPrimitive.Content>,
    VariantProps<typeof getSheetVariants> {}
  ...
  >(({ side = "right", className, children, ...props }, ref) => {
    const { theme } = useLocaleStore();
    const { cva: sheetVariants, style: sheetStyles } = getSheetVariants(theme); 
