...
export function ToedurLanguageSelector({className}: ToedurLanguageSelectorProps) {
    ...
    <ToedurButton className={className}>
      ...
      {isOpen && (
        <MotionDiv
          ...
          className="absolute top-full  left-0 w-full mt-4 z-10 p-2"
    ...
    <ToedurButton className={className}>
      ...
      {isOpen && (
        <MotionDiv
          ...
          className="absolute top-[-43%]  left-[92px] w-full mt-4 z-10 p-2"
          initial={{ opacity: 0, y: -10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
        >
